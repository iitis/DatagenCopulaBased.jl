...
@testset "gaussian copula" begin
  ...
  @testset "examples on data" begin
    ...
    Random.seed!(43)
    x = simulate_copula1(350000, Gaussian_cop([1. 0.5; 0.5 1.]))
...
@testset "t-student copula" begin
  ...
  @testset "example on data" begin
    ...
    Random.seed!(43)
    xt = simulate_copula1(350000, Student_cop([1. rho; rho 1.], ν))
...
@testset "Frechet copula" begin
  ...
  @testset "examples on larger data" begin
    Random.seed!(43)
    x = simulate_copula1(350000, Frechet_cop(3, 0.3))
    @test pvalue(ExactOneSampleKSTest(x[:,1], Uniform(0,1))) > α
    @test pvalue(ExactOneSampleKSTest(x[:,2], Uniform(0,1))) > α
    ...
    x = simulate_copula1(350000, Frechet_cop(3, 1.))
    ...
    x = simulate_copula1(350000, Frechet_cop(2, 0.8, 0.1));
    @test pvalue(ExactOneSampleKSTest(x[:,1], Uniform(0,1))) > α
    @test pvalue(ExactOneSampleKSTest(x[:,2], Uniform(0,1))) > α
